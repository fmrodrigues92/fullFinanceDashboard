...
return [
    ...
    | como as regras de tamanho. Fique à vontade para ajustar as mensagens.
    |
    */
    ...
    | Isso facilita definir uma mensagem específica para cada regra.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de idioma a seguir são usadas para substituir o placeholder
    | do atributo por algo mais amigável, como "Endereço de e-mail" em vez
    | de "email". Isso ajuda a tornar a mensagem mais expressiva.
    |
    */
